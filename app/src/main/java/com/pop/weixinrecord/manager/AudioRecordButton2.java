...
import com.pop.weixinrecord.utils.FileUtils;

//录音按钮核心类，包括点击、响应、与弹出对话框交互等操作。
public class AudioRecordButton2 extends Button implements AudioManager.AudioStageListener, DialogRecordManager.Callback {
    ...
    public AudioRecordButton2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;


        //初始化语音对话框
        mDialogManager = new DialogRecordManager(getContext() ,this);
